...
class Constant{
  static TextStyle textSearch=TextStyle(fontSize: 12.px,fontWeight: FontWeight.w400,color: MyColor.greyColor,fontFamily: "medium");
  static TextStyle textLoginHint=TextStyle(fontSize: 16.sp,fontWeight: FontWeight.w400,color: MyColor.greyColor);
  static TextStyle textButton=TextStyle(fontSize: 15.sp,fontWeight: FontWeight.w600,color: MyColor.whiterColor);
  static TextStyle textGreySign=TextStyle(fontSize: 14.sp,fontWeight: FontWeight.w500,color: MyColor.greyWithSign);
  ...
  static TextStyle textRegister=TextStyle(fontSize: 24.sp,fontWeight: FontWeight.w600,color: MyColor.blackBoldColor);
