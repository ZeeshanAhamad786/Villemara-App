...
class Constant {
  static TextStyle textSearch = TextStyle(
      fontSize: 12.px,
  ...
  static TextStyle textSubtitle = TextStyle(
      ...
      color: MyColor.blackBoldColor,
      fontFamily: "medium");
  static TextStyle textGreySign = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeight.w500,
      color: MyColor.greyWithSign);
  static TextStyle textBlackShine = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeight.w500,
  ...
  static TextStyle textCoordinateName = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeight.w400,
      color: MyColor.blackBoldColor);
  static TextStyle textTeacher = TextStyle(
      fontSize: 13.sp,
      fontWeight: FontWeight.w400,
      color: MyColor.blackBoldColor);
  static TextStyle textTeacherNumber = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w200,
    color: MyColor.blackBoldColor,
  );
  static TextStyle textTotalMatrices = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeight.w600,
    color: MyColor.blackBoldColor,
  );
  static TextStyle textNotification = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w400,
    color: MyColor.blackBoldColor,
  );
  static TextStyle textLikeName = TextStyle(
      fontSize: 15.sp,
      fontWeight: FontWeight.w400,
      color: MyColor.blackBoldColor,
      fontFamily: "medium");
  static TextStyle textLikes = TextStyle(
      fontSize: 18.sp,
      fontWeight: FontWeight.w400,
  ...
  static TextStyle textMainTitle = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w400,
    color: MyColor.blackBoldColor,
  );
  static TextStyle textDesc = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeight.w400,
      color: MyColor.blackBoldColor,
      fontFamily: "medium");
  ...
  static TextStyle textNameBold = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeight.w400,
    color: MyColor.blackBoldColor,
  );
  static TextStyle textDone = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeight.w400,
      color: MyColor.white,
      fontFamily: "regular");
  static TextStyle choosePerson = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeight.w400,
